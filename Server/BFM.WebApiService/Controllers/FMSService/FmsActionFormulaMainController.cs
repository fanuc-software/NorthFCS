...
{
    /// <summary>
    /// FmsActionFormulaMain ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("FMSService/FmsActionFormulaMain")]
    public class FmsActionFormulaMainController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<FmsActionFormulaMain> GetFmsActionFormulaMains([FromBody]string sWhere)
        {
            Expression<Func<FmsActionFormulaMain, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<FmsActionFormulaMain>(sWhere);
            using (IFmsActionFormulaMainBLL FmsActionFormulaMainBLL = BLLContainer.Resolve<IFmsActionFormulaMainBLL>())
            {
