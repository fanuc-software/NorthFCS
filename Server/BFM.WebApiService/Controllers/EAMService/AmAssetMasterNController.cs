...
{
    /// <summary>
    /// AmAssetMasterN ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("EAMService/AmAssetMasterN")]
    public class AmAssetMasterNController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<AmAssetMasterN> GetAmAssetMasterNs([FromBody]string sWhere)
        {
            Expression<Func<AmAssetMasterN, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<AmAssetMasterN>(sWhere);
            using (IAmAssetMasterNBLL AmAssetMasterNBLL = BLLContainer.Resolve<IAmAssetMasterNBLL>())
            {
