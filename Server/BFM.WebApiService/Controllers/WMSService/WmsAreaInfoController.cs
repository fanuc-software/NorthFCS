...
{
    /// <summary>
    /// WmsAreaInfo ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("WMSService/WmsAreaInfo")]
    public class WmsAreaInfoController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<WmsAreaInfo> GetWmsAreaInfos([FromBody]string sWhere)
        {
            Expression<Func<WmsAreaInfo, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<WmsAreaInfo>(sWhere);
            using (IWmsAreaInfoBLL WmsAreaInfoBLL = BLLContainer.Resolve<IWmsAreaInfoBLL>())
            {
