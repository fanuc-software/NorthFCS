...
{
    /// <summary>
    /// MesJobOrder ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("PLMService/MesJobOrder")]
    public class MesJobOrderController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<MesJobOrder> GetMesJobOrders([FromBody]string sWhere)
        {
            Expression<Func<MesJobOrder, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<MesJobOrder>(sWhere);
            using (IMesJobOrderBLL MesJobOrderBLL = BLLContainer.Resolve<IMesJobOrderBLL>())
            {
