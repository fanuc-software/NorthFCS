...
{
    /// <summary>
    /// QmsRoutingCheck ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("QMSService/QmsRoutingCheck")]
    public class QmsRoutingCheckController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<QmsRoutingCheck> GetQmsRoutingChecks([FromBody]string sWhere)
        {
            Expression<Func<QmsRoutingCheck, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<QmsRoutingCheck>(sWhere);
            using (IQmsRoutingCheckBLL QmsRoutingCheckBLL = BLLContainer.Resolve<IQmsRoutingCheckBLL>())
            {
