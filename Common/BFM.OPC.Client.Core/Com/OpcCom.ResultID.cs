...
{
	#region Contains a unique identifier for a result code.
	...
	#region Used to raise an exception with associated with a specified result code.
	...
	#region Defines all well known COM DA HRESULT codes.
