...
{
    /// <summary>
    /// SysEnumItems ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("SDMService/SysEnumItems")]
    public class SysEnumItemsController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<SysEnumItems> GetSysEnumItemss([FromBody]string sWhere)
        {
            Expression<Func<SysEnumItems, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<SysEnumItems>(sWhere);
            using (ISysEnumItemsBLL SysEnumItemsBLL = BLLContainer.Resolve<ISysEnumItemsBLL>())
            {
