...
{
    /// <summary>
    /// DAMachineRealTimeInfo ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("DAService/DAMachineRealTimeInfo")]
    public class DAMachineRealTimeInfoController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<DAMachineRealTimeInfo> GetDAMachineRealTimeInfos([FromBody]string sWhere)
        {
            Expression<Func<DAMachineRealTimeInfo, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<DAMachineRealTimeInfo>(sWhere);
            using (IDAMachineRealTimeInfoBLL DAMachineRealTimeInfoBLL = BLLContainer.Resolve<IDAMachineRealTimeInfoBLL>())
            {
