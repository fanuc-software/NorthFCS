...
{
    /// <summary>
    /// FmsStateResultRecord ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("FMSService/FmsStateResultRecord")]
    public class FmsStateResultRecordController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<FmsStateResultRecord> GetFmsStateResultRecords([FromBody]string sWhere)
        {
            Expression<Func<FmsStateResultRecord, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<FmsStateResultRecord>(sWhere);
            using (IFmsStateResultRecordBLL FmsStateResultRecordBLL = BLLContainer.Resolve<IFmsStateResultRecordBLL>())
            {
