...
{
    /// <summary>
    /// RsEquipMaster ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("RSMService/RsEquipMaster")]
    public class RsEquipMasterController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<RsEquipMaster> GetRsEquipMasters([FromBody]string sWhere)
        {
            Expression<Func<RsEquipMaster, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<RsEquipMaster>(sWhere);
            using (IRsEquipMasterBLL RsEquipMasterBLL = BLLContainer.Resolve<IRsEquipMasterBLL>())
            {
