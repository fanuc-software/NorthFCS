...
{
    /// <summary>
    /// SysAppInfo ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("SDMService/SysAppInfo")]
    public class SysAppInfoController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<SysAppInfo> GetSysAppInfos([FromBody]string sWhere)
        {
            Expression<Func<SysAppInfo, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<SysAppInfo>(sWhere);
            using (ISysAppInfoBLL SysAppInfoBLL = BLLContainer.Resolve<ISysAppInfoBLL>())
            {
