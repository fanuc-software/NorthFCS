...
namespace BFM.ContractModel 
{
    ...
    public class RsWorkCenter
    {
        ...
        /// </summary> 
        [DataMember]
        [Display(Name = "WC_NAME", Description = "工作中心名称")]
        ...
        private Int32 _EQUIP_QTY;
        /// <summary> 
        ///  设备数
        /// </summary> 
        [DataMember]
        [Display(Name = "EQUIP_QTY", Description = "设备数")]
        public Int32 EQUIP_QTY
        {
            get { return _EQUIP_QTY; }
            set { _EQUIP_QTY = value; }
        }
