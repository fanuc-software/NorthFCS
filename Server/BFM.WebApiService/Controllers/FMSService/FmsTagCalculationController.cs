...
{
    /// <summary>
    /// FmsTagCalculation ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("FMSService/FmsTagCalculation")]
    public class FmsTagCalculationController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<FmsTagCalculation> GetFmsTagCalculations([FromBody]string sWhere)
        {
            Expression<Func<FmsTagCalculation, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<FmsTagCalculation>(sWhere);
            using (IFmsTagCalculationBLL FmsTagCalculationBLL = BLLContainer.Resolve<IFmsTagCalculationBLL>())
            {
