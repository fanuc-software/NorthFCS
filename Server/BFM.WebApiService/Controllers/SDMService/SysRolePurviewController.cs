...
{
    /// <summary>
    /// SysRolePurview ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("SDMService/SysRolePurview")]
    public class SysRolePurviewController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<SysRolePurview> GetSysRolePurviews([FromBody]string sWhere)
        {
            Expression<Func<SysRolePurview, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<SysRolePurview>(sWhere);
            using (ISysRolePurviewBLL SysRolePurviewBLL = BLLContainer.Resolve<ISysRolePurviewBLL>())
            {
