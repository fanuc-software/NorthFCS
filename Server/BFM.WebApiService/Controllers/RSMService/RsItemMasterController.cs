...
{
    /// <summary>
    /// RsItemMaster ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("RSMService/RsItemMaster")]
    public class RsItemMasterController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<RsItemMaster> GetRsItemMasters([FromBody]string sWhere)
        {
            Expression<Func<RsItemMaster, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<RsItemMaster>(sWhere);
            using (IRsItemMasterBLL RsItemMasterBLL = BLLContainer.Resolve<IRsItemMasterBLL>())
            {
