...
{
    /// <summary>
    /// SysMenuItem ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("SDMService/SysMenuItem")]
    public class SysMenuItemController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<SysMenuItem> GetSysMenuItems([FromBody]string sWhere)
        {
            Expression<Func<SysMenuItem, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<SysMenuItem>(sWhere);
            using (ISysMenuItemBLL SysMenuItemBLL = BLLContainer.Resolve<ISysMenuItemBLL>())
            {
