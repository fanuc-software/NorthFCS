...
{
    /// <summary>
    /// SysPurview ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("SDMService/SysPurview")]
    public class SysPurviewController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<SysPurview> GetSysPurviews([FromBody]string sWhere)
        {
            Expression<Func<SysPurview, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<SysPurview>(sWhere);
            using (ISysPurviewBLL SysPurviewBLL = BLLContainer.Resolve<ISysPurviewBLL>())
            {
