...
{
    /// <summary>
    /// SysAttachInfo ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("SDMService/SysAttachInfo")]
    public class SysAttachInfoController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<SysAttachInfo> GetSysAttachInfos([FromBody]string sWhere)
        {
            Expression<Func<SysAttachInfo, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<SysAttachInfo>(sWhere);
            using (ISysAttachInfoBLL SysAttachInfoBLL = BLLContainer.Resolve<ISysAttachInfoBLL>())
            {
