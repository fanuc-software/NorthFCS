...
{
    /// <summary>
    /// RsRoutingEquip ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("RSMService/RsRoutingEquip")]
    public class RsRoutingEquipController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<RsRoutingEquip> GetRsRoutingEquips([FromBody]string sWhere)
        {
            Expression<Func<RsRoutingEquip, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<RsRoutingEquip>(sWhere);
            using (IRsRoutingEquipBLL RsRoutingEquipBLL = BLLContainer.Resolve<IRsRoutingEquipBLL>())
            {
