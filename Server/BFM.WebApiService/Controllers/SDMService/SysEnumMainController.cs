...
{
    /// <summary>
    /// SysEnumMain ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("SDMService/SysEnumMain")]
    public class SysEnumMainController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<SysEnumMain> GetSysEnumMains([FromBody]string sWhere)
        {
            Expression<Func<SysEnumMain, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<SysEnumMain>(sWhere);
            using (ISysEnumMainBLL SysEnumMainBLL = BLLContainer.Resolve<ISysEnumMainBLL>())
            {
