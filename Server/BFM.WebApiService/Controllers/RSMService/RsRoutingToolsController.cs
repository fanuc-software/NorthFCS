...
{
    /// <summary>
    /// RsRoutingTools ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("RSMService/RsRoutingTools")]
    public class RsRoutingToolsController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<RsRoutingTools> GetRsRoutingToolss([FromBody]string sWhere)
        {
            Expression<Func<RsRoutingTools, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<RsRoutingTools>(sWhere);
            using (IRsRoutingToolsBLL RsRoutingToolsBLL = BLLContainer.Resolve<IRsRoutingToolsBLL>())
            {
