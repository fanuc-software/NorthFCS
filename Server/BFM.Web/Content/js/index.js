...
function GetLoadNav() {
    ...
    $.each(data, function (i) {
        var row = data[i];
        if (row.PARENT_PKNO == "0") {
            _html += '<li>';
            _html += '<a data-id="' + row.PKNO + '" href="#" class="dropdown-toggle"><i class="' + row.PAGE_ID + '"></i><span>' + row.ITEM_TITLE + '</span><i class="fa fa-angle-right drop-icon"></i></a>';
            ...
            if (childNodes.length > 0) {
                ...
                $.each(childNodes, function (i) {
                    ...
                    _html += '<li>';
                    _html += '<a class="menuItem" data-id="' + subrow.PKNO + '" href="' + subrow.PAGE_ID + '" data-index="' + subrow.ASSEMBLY_NAME + '">' + subrow.ITEM_TITLE + '</a>';
                    _html += '</li>';
                });
                _html += '</ul>';
            }
