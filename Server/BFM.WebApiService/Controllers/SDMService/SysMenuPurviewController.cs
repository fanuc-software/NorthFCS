...
{
    /// <summary>
    /// SysMenuPurview ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("SDMService/SysMenuPurview")]
    public class SysMenuPurviewController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<SysMenuPurview> GetSysMenuPurviews([FromBody]string sWhere)
        {
            Expression<Func<SysMenuPurview, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<SysMenuPurview>(sWhere);
            using (ISysMenuPurviewBLL SysMenuPurviewBLL = BLLContainer.Resolve<ISysMenuPurviewBLL>())
            {
