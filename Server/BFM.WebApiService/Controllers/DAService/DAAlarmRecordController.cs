...
{
    /// <summary>
    /// DAAlarmRecord ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("DAService/DAAlarmRecord")]
    public class DAAlarmRecordController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<DAAlarmRecord> GetDAAlarmRecords([FromBody]string sWhere)
        {
            Expression<Func<DAAlarmRecord, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<DAAlarmRecord>(sWhere);
            using (IDAAlarmRecordBLL DAAlarmRecordBLL = BLLContainer.Resolve<IDAAlarmRecordBLL>())
            {
