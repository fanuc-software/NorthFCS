...
{
    /// <summary>
    /// RsMaintainStandardsDetail ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("EAMService/RsMaintainStandardsDetail")]
    public class RsMaintainStandardsDetailController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<RsMaintainStandardsDetail> GetRsMaintainStandardsDetails([FromBody]string sWhere)
        {
            Expression<Func<RsMaintainStandardsDetail, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<RsMaintainStandardsDetail>(sWhere);
            using (IRsMaintainStandardsDetailBLL RsMaintainStandardsDetailBLL = BLLContainer.Resolve<IRsMaintainStandardsDetailBLL>())
            {
