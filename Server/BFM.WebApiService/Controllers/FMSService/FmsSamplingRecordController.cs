...
{
    /// <summary>
    /// FmsSamplingRecord ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("FMSService/FmsSamplingRecord")]
    public class FmsSamplingRecordController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<FmsSamplingRecord> GetFmsSamplingRecords([FromBody]string sWhere)
        {
            Expression<Func<FmsSamplingRecord, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<FmsSamplingRecord>(sWhere);
            using (IFmsSamplingRecordBLL FmsSamplingRecordBLL = BLLContainer.Resolve<IFmsSamplingRecordBLL>())
            {
