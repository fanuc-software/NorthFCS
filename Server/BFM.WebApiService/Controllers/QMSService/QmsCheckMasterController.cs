...
{
    /// <summary>
    /// QmsCheckMaster ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("QMSService/QmsCheckMaster")]
    public class QmsCheckMasterController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<QmsCheckMaster> GetQmsCheckMasters([FromBody]string sWhere)
        {
            Expression<Func<QmsCheckMaster, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<QmsCheckMaster>(sWhere);
            using (IQmsCheckMasterBLL QmsCheckMasterBLL = BLLContainer.Resolve<IQmsCheckMasterBLL>())
            {
