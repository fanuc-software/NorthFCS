...
{
    /// <summary>
    /// SysDepartment ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("SDMService/SysDepartment")]
    public class SysDepartmentController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<SysDepartment> GetSysDepartments([FromBody]string sWhere)
        {
            Expression<Func<SysDepartment, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<SysDepartment>(sWhere);
            using (ISysDepartmentBLL SysDepartmentBLL = BLLContainer.Resolve<ISysDepartmentBLL>())
            {
