...
{
    /// <summary>
    /// RsMaintainRecord ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("EAMService/RsMaintainRecord")]
    public class RsMaintainRecordController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<RsMaintainRecord> GetRsMaintainRecords([FromBody]string sWhere)
        {
            Expression<Func<RsMaintainRecord, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<RsMaintainRecord>(sWhere);
            using (IRsMaintainRecordBLL RsMaintainRecordBLL = BLLContainer.Resolve<IRsMaintainRecordBLL>())
            {
