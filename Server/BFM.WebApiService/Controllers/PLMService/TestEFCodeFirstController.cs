...
{
    /// <summary>
    /// TestEFCodeFirst ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("PLMService/TestEFCodeFirst")]
    public class TestEFCodeFirstController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<TestEFCodeFirst> GetTestEFCodeFirsts([FromBody]string sWhere)
        {
            Expression<Func<TestEFCodeFirst, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<TestEFCodeFirst>(sWhere);
            using (ITestEFCodeFirstBLL TestEFCodeFirstBLL = BLLContainer.Resolve<ITestEFCodeFirstBLL>())
            {
