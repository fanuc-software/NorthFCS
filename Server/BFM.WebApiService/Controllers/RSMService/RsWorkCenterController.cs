...
{
    /// <summary>
    /// RsWorkCenter ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("RSMService/RsWorkCenter")]
    public class RsWorkCenterController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<RsWorkCenter> GetRsWorkCenters([FromBody]string sWhere)
        {
            Expression<Func<RsWorkCenter, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<RsWorkCenter>(sWhere);
            using (IRsWorkCenterBLL RsWorkCenterBLL = BLLContainer.Resolve<IRsWorkCenterBLL>())
            {
