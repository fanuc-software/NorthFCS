...
{
    /// <summary>
    /// RsMaintainStandards ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("EAMService/RsMaintainStandards")]
    public class RsMaintainStandardsController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<RsMaintainStandards> GetRsMaintainStandardss([FromBody]string sWhere)
        {
            Expression<Func<RsMaintainStandards, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<RsMaintainStandards>(sWhere);
            using (IRsMaintainStandardsBLL RsMaintainStandardsBLL = BLLContainer.Resolve<IRsMaintainStandardsBLL>())
            {
