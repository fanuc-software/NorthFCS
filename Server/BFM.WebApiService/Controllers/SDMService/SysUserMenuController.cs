...
{
    /// <summary>
    /// SysUserMenu ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("SDMService/SysUserMenu")]
    public class SysUserMenuController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<SysUserMenu> GetSysUserMenus([FromBody]string sWhere)
        {
            Expression<Func<SysUserMenu, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<SysUserMenu>(sWhere);
            using (ISysUserMenuBLL SysUserMenuBLL = BLLContainer.Resolve<ISysUserMenuBLL>())
            {
