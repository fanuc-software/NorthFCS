...
{
    /// <summary>
    /// FmsAssetTagSetting ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("FMSService/FmsAssetTagSetting")]
    public class FmsAssetTagSettingController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<FmsAssetTagSetting> GetFmsAssetTagSettings([FromBody]string sWhere)
        {
            Expression<Func<FmsAssetTagSetting, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<FmsAssetTagSetting>(sWhere);
            using (IFmsAssetTagSettingBLL FmsAssetTagSettingBLL = BLLContainer.Resolve<IFmsAssetTagSettingBLL>())
            {
