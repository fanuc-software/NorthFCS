...
{
    /// <summary>
    /// RmRepairRecord ApiController
    /// </summary>
    [AllowAnonymous]
    [RoutePrefix("EAMService/RmRepairRecord")]
    public class RmRepairRecordController : ApiController 
    {
        ...
        [Route("GetByParam")]
        [HttpPost]
        public List<RmRepairRecord> GetRmRepairRecords([FromBody]string sWhere)
        {
            Expression<Func<RmRepairRecord, bool>> whereLamda = SerializerHelper.ConvertParamWhereToLinq<RmRepairRecord>(sWhere);
            using (IRmRepairRecordBLL RmRepairRecordBLL = BLLContainer.Resolve<IRmRepairRecordBLL>())
            {
